        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-end pt-4 border-t">
              {canCompleteStep && !isDocumentComplete && activeTab !== 'complete' && (
                <button
                  onClick={() => setActiveTab('complete')}
                  className="px-6 py-2 rounded-lg transition-all font-medium mr-3 bg-green-50 text-green-700 hover:bg-green-100"
                >
                  Complete Step
                </button>
              )}
